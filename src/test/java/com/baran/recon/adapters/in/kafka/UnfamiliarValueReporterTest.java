...
@DisplayName("FR-LED-9: a projected value this service does not know is warned about once and counted")
class UnfamiliarValueReporterTest {

    private final SimpleMeterRegistry meters = new SimpleMeterRegistry();
    private final UnfamiliarValueReporter reporter = new UnfamiliarValueReporter(meters);
    ...
    private static LedgerEvent event(String txType) {
        return new LedgerEvent(1, Optional.of(2L), Optional.of(Instant.parse("2026-09-24T08:15:42.318204Z")),
                UUID.randomUUID(), UUID.randomUUID(), 100, CurrencyCode.of("TRY"), txType);
    }
}
